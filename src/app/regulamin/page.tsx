...
export const metadata: Metadata = {
  ...
  description: 'Regulamin korzystania z kalkulatora kredytowego. Warunki użytkowania serwisu.',
}
      ...
      <ContentWrapper>
        ...
        <Content>
          <Section>
            ...
            <Paragraph>
              1. Niniejszy regulamin określa zasady korzystania z kalkulatora kredytowego dostępnego
              na stronie internetowej.
            </Paragraph>
            <Paragraph>
              2. Kalkulator kredytowy służy wyłącznie celom informacyjnym i ma charakter
              orientacyjny.
            </Paragraph>
            <Paragraph>
              3. Korzystanie z kalkulatora jest bezpłatne i nie wymaga rejestracji.
            </Paragraph>
          </Section>

          <Section>
            <SectionTitle>§2. Zakres usług</SectionTitle>
            <Paragraph>1. Kalkulator kredytowy umożliwia użytkownikom:</Paragraph>
            <List>
              <ListItem>Wyliczenie orientacyjnej wysokości raty kredytu hipotecznego</ListItem>
              <ListItem>Porównanie ofert kredytowych różnych banków</ListItem>
              <ListItem>Oszacowanie całkowitego kosztu kredytu</ListItem>
              <ListItem>Analizę wpływu wkładu własnego na warunki kredytu</ListItem>
            </List>
            <Paragraph>
              2. Wyniki kalkulacji mają charakter szacunkowy i nie stanowią oferty w rozumieniu
              Kodeksu cywilnego.
            </Paragraph>
            <Paragraph>
              3. Rzeczywiste warunki kredytu mogą się różnić od wyników kalkulacji i zależą od
              indywidualnej oceny zdolności kredytowej przez bank.
            </Paragraph>
          </Section>

          <Section>
            <SectionTitle>§3. Odpowiedzialność</SectionTitle>
            <Paragraph>1. Administrator serwisu nie ponosi odpowiedzialności za:</Paragraph>
            <List>
              <ListItem>Decyzje finansowe podjęte na podstawie wyników kalkulacji</ListItem>
              <ListItem>
                Różnice między wynikami kalkulacji a rzeczywistymi warunkami oferowanymi przez banki
              </ListItem>
              <ListItem>Aktualizację danych ofert bankowych w czasie rzeczywistym</ListItem>
              <ListItem>Szkody powstałe w wyniku korzystania z kalkulatora</ListItem>
            </List>
            <Paragraph>
              2. Dane prezentowane w kalkulatorze są regularnie aktualizowane, jednak mogą różnić
              się od aktualnych ofert banków.
            </Paragraph>
            <Paragraph>
              3. Użytkownik powinien zawsze zweryfikować warunki kredytu bezpośrednio w banku przed
          ...
          <Section>
            ...
            <Paragraph>
              1. Kalkulator nie wymaga podawania danych osobowych do wykonania podstawowych
              obliczeń.
            </Paragraph>
            <Paragraph>
              2. Dane wprowadzane do kalkulatora (kwoty, okresy) nie są przechowywane na serwerze i
              pozostają tylko w przeglądarce użytkownika.
            </Paragraph>
            <Paragraph>
          ...
          <Section>
            ...
            <Paragraph>
              1. Wszystkie treści zamieszczone na stronie, w tym kod kalkulatora, grafiki i teksty,
              są chronione prawem autorskim.
            </Paragraph>
            <Paragraph>
              2. Kopiowanie, modyfikowanie lub rozpowszechnianie zawartości serwisu bez zgody
          ...
          <Section>
            ...
            <Paragraph>
              2. O zmianach użytkownicy zostaną poinformowani poprzez zamieszczenie nowej wersji
              regulaminu na stronie.
            </Paragraph>
            <Paragraph>
              3. Dalsze korzystanie z kalkulatora po wprowadzeniu zmian oznacza akceptację nowego
              regulaminu.
            </Paragraph>
          </Section>
          ...
          <Section>
            ...
            <Paragraph>
              2. Wszelkie spory wynikłe z korzystania z kalkulatora będą rozstrzygane przez właściwe
              sądy polskie.
            </Paragraph>
            <Paragraph>3. Regulamin wchodzi w życie z dniem publikacji na stronie.</Paragraph>
          </Section>
