    ...
    <HydrateClient>
      <Main>
        <Container>
          ...
          <Grid>
            <StyledLink href="https://create.t3.gg/en/usage/first-steps" target="_blank">
            ...
            <StyledLink href="https://create.t3.gg/en/introduction" target="_blank">
          ...
          <InfoSection>
            <InfoText>{hello ? hello.greeting : 'Loading tRPC query...'}</InfoText>
          </InfoSection>
