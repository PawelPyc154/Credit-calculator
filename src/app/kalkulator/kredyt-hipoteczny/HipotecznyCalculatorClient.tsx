...
type HipotecznyCalculatorClientProps = {
  initialResults: CalculationResult[]
  initialFormData: CalculatorFormData
}

export function HipotecznyCalculatorClient({
  initialResults,
  initialFormData,
}: HipotecznyCalculatorClientProps) {
  ...
  const handleCalculate = useCallback(
    (newFormData: CalculatorFormData) => {
      try {
        const calculatedResults = calculateBankOffers(newFormData, banksData)
        setResults(calculatedResults)
        setFormData(newFormData)

        trackCalculation({
          loanAmount: newFormData.loanAmount,
          loanPeriod: newFormData.loanPeriod,
          downPayment: newFormData.downPayment,
          monthlyIncome: newFormData.monthlyIncome,
          purpose: newFormData.purpose,
          interestRateType: newFormData.interestRateType || 'variable',
