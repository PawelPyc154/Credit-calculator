...
export const CookieBanner = () => {
  const { showBanner, acceptAll, rejectAll, acceptSelected } =
    useCookieConsent();
        ...
        <SettingsModal>
          ...
          <ModalContent>
            <ModalDescription>
              ...
              oraz analizować ruch. Możesz wybrać, które kategorie cookies
              chcesz zaakceptować.
            </ModalDescription>
              ...
              <CategoryCard>
                <CategoryHeader>
                  <CategoryInfo>
                    ...
                    <CategoryDescription>
                      Te pliki są niezbędne do prawidłowego działania strony.
                ...
                <CategoryHeader>
                  <CategoryInfo>
                    ...
                    <CategoryDescription>
                      ...
                      strony. Używamy Google Analytics.
                    </CategoryDescription>
                  </CategoryInfo>
                  <Toggle
              ...
              <CategoryCard>
                <CategoryHeader>
                  <CategoryInfo>
                    ...
                    <CategoryDescription>
                      Służą do wyświetlania spersonalizowanych reklam. Używamy
                      Google AdSense.
                    </CategoryDescription>
                  </CategoryInfo>
                  <Toggle
            ...
            <ModalLinks>
              <ModalLink href="/polityka-prywatnosci">
      ...
      <BannerContent>
        ...
        <BannerText>
          ...
          <BannerDescription>
            ...
            naszej stronie. Klikając "Akceptuj wszystkie", zgadzasz się na
            przechowywanie plików cookies na swoim urządzeniu.{" "}
            <BannerLink href="/polityka-prywatnosci">
              Polityka prywatności
            </BannerLink>
          </BannerDescription>
        </BannerText>
...
const CookieCategories = tw.div`space-y-4 mb-6`;
